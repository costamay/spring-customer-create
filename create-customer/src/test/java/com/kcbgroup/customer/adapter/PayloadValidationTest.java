...
public class PayloadValidationTest extends KCBCamelRouterTestSupport{
	
	private static final Logger logger = LoggerFactory.getLogger(PayloadValidationTest.class);
	 ...
	 */
	@Test
	public void payloadValidationSuccessTest()
			throws Exception {
		
		logger.info("payloadValidationSuccessTest");
	 ...
	 */
	@Test
	public void payloadValidationFailureTest()
			throws Exception {
		...
		String case2 = this.sendMessage("direct:validateRequest", jsonRequest.replaceAll("routeCode", "routeCodes"), header2);
