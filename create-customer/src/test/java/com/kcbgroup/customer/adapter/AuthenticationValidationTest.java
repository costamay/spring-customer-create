...
public class AuthenticationValidationTest extends KCBCamelRouterTestSupport{
	
	private static final Logger logger = LoggerFactory.getLogger(AuthenticationValidationTest.class);
	 ...
	 */
	@Test
	public void authenticationValidationSuccessTest()
			throws Exception {
		
		logger.info("authenticationValidationSuccessTest");
		...
		String case1 = this.sendMessage("direct:authenticateRequest", jsonRequest, header1);	
	 ...
	 */
	@Test
	public void authenticationValidationFailureTest()
			throws Exception {

		logger.info("authenticationValidationFailureTest");
		
		Map<String, Object> header2 = new HashMap<String, Object>();

		// Case 2: Error (wrong credentials)
		header2.put("Authorization", "Basic YXRtLTEwMTp0ZXN0QDEyMw==XYZ");
		header2.put("messageID", "TEST-CC-00001");
		header2.put("channelCode", "101");
		String case2 = this.sendMessage("direct:authenticateRequest", jsonRequest, header2);

		// Case 2: DataValidationException
		assertNotNull(case2);
		assertFalse(case2.contains("OSP-1002"));
	}	
}